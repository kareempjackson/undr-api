...
exports.CreateEscrowSystem1711168500000 = void 0;
class CreateEscrowSystem1711168500000 {
    constructor() {
        this.name = "CreateEscrowSystem1711168500000";
    }
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_escrows_toUser"`);
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_escrows_fromUser"`);
        await queryRunner.query(`ALTER TABLE "escrows" DROP CONSTRAINT "FK_escrows_payments"`);
        await queryRunner.query(`DROP INDEX "IDX_transaction_logs_stripeDisputeId"`);
        await queryRunner.query(`DROP INDEX "IDX_transaction_logs_stripePaymentIntentId"`);
        await queryRunner.query(`DROP INDEX "IDX_transaction_logs_userId"`);
        await queryRunner.query(`DROP INDEX "IDX_transaction_logs_paymentId"`);
        await queryRunner.query(`DROP INDEX "IDX_transaction_logs_escrowId"`);
        await queryRunner.query(`DROP INDEX "IDX_transaction_logs_type"`);
        await queryRunner.query(`DROP INDEX "IDX_delivery_proofs_escrowId"`);
        await queryRunner.query(`DROP INDEX "IDX_escrows_status"`);
        await queryRunner.query(`DROP INDEX "IDX_escrows_toUserId"`);
        await queryRunner.query(`DROP INDEX "IDX_escrows_fromUserId"`);
        await queryRunner.query(`DROP INDEX "IDX_escrows_paymentId"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."proof_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."escrow_status_enum"`);
    }
}
exports.CreateEscrowSystem1711168500000 = CreateEscrowSystem1711168500000;
//# sourceMappingURL=1711168500000-CreateEscrowSystem.js.map
...
exports.InitialMigration1742510834040 = void 0;
class InitialMigration1742510834040 {
    constructor() {
        this.name = 'InitialMigration1742510834040';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_method_enum" AS ENUM('WALLET', 'CREDIT_CARD', 'CRYPTO_BTC', 'CRYPTO_ETH', 'CRYPTO_USDT')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."deposits_status_enum" AS ENUM('PENDING', 'COMPLETED', 'FAILED')`);
        await queryRunner.query(`CREATE TYPE "public"."deposits_method_enum" AS ENUM('WALLET', 'CREDIT_CARD', 'CRYPTO_BTC', 'CRYPTO_ETH', 'CRYPTO_USDT')`);
        ...
        await queryRunner.query(`CREATE TABLE "magic_links" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "used" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, CONSTRAINT "PK_6c609d48037f164e7ae5b744b18" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('ADMIN', 'CREATOR', 'FAN')`);
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('ACTIVE', 'PENDING', 'SUSPENDED', 'DELETED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."withdrawals_status_enum" AS ENUM('PENDING', 'COMPLETED', 'FAILED', 'REJECTED')`);
        await queryRunner.query(`CREATE TYPE "public"."withdrawals_method_enum" AS ENUM('WALLET', 'CREDIT_CARD', 'CRYPTO_BTC', 'CRYPTO_ETH', 'CRYPTO_USDT')`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "deposits" DROP CONSTRAINT "FK_968bcd26d29022f95d20bb70e21"`);
...
exports.InitialMigration1742510834040 = InitialMigration1742510834040;
//# sourceMappingURL=1742510834040-InitialMigration.js.map
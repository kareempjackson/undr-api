...
export class AddEscrowSystem1711392384569 implements MigrationInterface {
  name = "AddEscrowSystem1711392384569";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Create the EscrowMilestone table
    await queryRunner.query(`
    ...
    // Create the DeliveryProof table
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "delivery_proofs" DROP CONSTRAINT "FK_delivery_proofs_reviewer"`
    );
    await queryRunner.query(
      `ALTER TABLE "delivery_proofs" DROP CONSTRAINT "FK_delivery_proofs_escrow"`
    );
    await queryRunner.query(
      `ALTER TABLE "escrow_milestones" DROP CONSTRAINT "FK_escrow_milestones_escrow"`
    );
    await queryRunner.query(
      `ALTER TABLE "escrows" DROP CONSTRAINT "FK_escrows_seller"`
    );
    await queryRunner.query(
      `ALTER TABLE "escrows" DROP CONSTRAINT "FK_escrows_buyer"`
    );

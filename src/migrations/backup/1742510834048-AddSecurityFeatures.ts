...
export class AddSecurityFeatures1742511277216 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."disputes_status_enum" AS ENUM('OPEN', 'UNDER_REVIEW', 'RESOLVED_FOR_MERCHANT', 'RESOLVED_FOR_CUSTOMER', 'ESCALATED', 'CLOSED')`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."disputes_reason_enum" AS ENUM('PRODUCT_NOT_RECEIVED', 'PRODUCT_NOT_AS_DESCRIBED', 'UNAUTHORIZED_TRANSACTION', 'DUPLICATE_TRANSACTION', 'SUBSCRIPTION_CANCELED', 'OTHER')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "threeDsStatus" "public"."payments_threedsstatus_enum" DEFAULT 'NOT_REQUIRED'`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "threeDsUrl" character varying`
    );
    await queryRunner.query(`ALTER TABLE "payments" ADD "threeDsResult" jsonb`);
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "riskScore" numeric(5,2) NOT NULL DEFAULT '0'`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "hasDispute" boolean NOT NULL DEFAULT false`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "isHighRisk" boolean NOT NULL DEFAULT false`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "ipAddress" character varying`
    );
    await queryRunner.query(`ALTER TABLE "payments" ADD "deviceInfo" jsonb`);
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "browserInfo" character varying`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "isInternational" boolean NOT NULL DEFAULT false`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD "invoiceDetails" jsonb`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "mfaMethod" "public"."users_mfamethod_enum" NOT NULL DEFAULT 'NONE'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "highSecurityMode" boolean NOT NULL DEFAULT false`
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "trustedDevices" jsonb NOT NULL DEFAULT '[]'`
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "loginHistory" jsonb NOT NULL DEFAULT '[]'`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "disputes" ADD CONSTRAINT "FK_23f126d4aaaa9d67243895b784b" FOREIGN KEY ("filedByUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "disputes" ADD CONSTRAINT "FK_a2215614b176b851d3e431de9b9" FOREIGN KEY ("resolvedByUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "disputes" DROP CONSTRAINT "FK_a2215614b176b851d3e431de9b9"`
    );
    await queryRunner.query(
      `ALTER TABLE "disputes" DROP CONSTRAINT "FK_23f126d4aaaa9d67243895b784b"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "highSecurityMode"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" DROP COLUMN "invoiceDetails"`
    );
    await queryRunner.query(
      `ALTER TABLE "payments" DROP COLUMN "isInternational"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" DROP COLUMN "threeDsResult"`
    );
    await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "threeDsUrl"`);
    await queryRunner.query(
      `ALTER TABLE "payments" DROP COLUMN "threeDsStatus"`
    );
